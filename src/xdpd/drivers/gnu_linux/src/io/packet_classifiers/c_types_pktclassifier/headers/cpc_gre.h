...
#define GRE_PROT_TYPE_TRANSPARENT_ETHERNET_BRIDGING 0x6558 // as defined in IETF RFC 1701
...
#define GRE_PROT_TYPE_TRANSPARENT_ETHERNET_BRIDGING 0x0000000000005865
#else
