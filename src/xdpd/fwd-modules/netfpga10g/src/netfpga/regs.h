...
#define NETFPGA_OF_NUM_PKTS_DROPPED_0_REG	OF_BASE_ADDR+0x00
#define NETFPGA_OF_NUM_PKTS_DROPPED_1_REG	OF_BASE_ADDR+0x01
#define NETFPGA_OF_NUM_PKTS_DROPPED_2_REG	OF_BASE_ADDR+0x02
#define NETFPGA_OF_NUM_PKTS_DROPPED_3_REG	OF_BASE_ADDR+0x03
#define NETFPGA_OF_NUM_PKTS_DROPPED_4_REG	OF_BASE_ADDR+0x04
#define NETFPGA_OF_EXACT_HITS_REG		OF_BASE_ADDR+0x05
#define NETFPGA_OF_EXACT_MISSES_REG		OF_BASE_ADDR+0x06
#define NETFPGA_OF_WILDCARD_HITS_REG		OF_BASE_ADDR+0x07
#define NETFPGA_OF_WILDCARD_MISSES_REG		OF_BASE_ADDR+0x08
#define NETFPGA_OF_DL_PARSE_CNT_0_REG		OF_BASE_ADDR+0x09
#define NETFPGA_OF_DL_PARSE_CNT_1_REG		OF_BASE_ADDR+0x0a
#define NETFPGA_OF_DL_PARSE_CNT_2_REG		OF_BASE_ADDR+0x0b
#define NETFPGA_OF_DL_PARSE_CNT_3_REG		OF_BASE_ADDR+0x0c
#define NETFPGA_OF_DL_PARSE_CNT_4_REG		OF_BASE_ADDR+0x0d
#define NETFPGA_OF_MPLS_PARSE_CNT_0_REG		OF_BASE_ADDR+0x0e
#define NETFPGA_OF_MPLS_PARSE_CNT_1_REG		OF_BASE_ADDR+0x0f
#define NETFPGA_OF_MPLS_PARSE_CNT_2_REG		OF_BASE_ADDR+0x10
#define NETFPGA_OF_MPLS_PARSE_CNT_3_REG		OF_BASE_ADDR+0x11
#define NETFPGA_OF_MPLS_PARSE_CNT_4_REG		OF_BASE_ADDR+0x12
#define NETFPGA_OF_ARP_PARSE_CNT_0_REG		OF_BASE_ADDR+0x13
#define NETFPGA_OF_ARP_PARSE_CNT_1_REG		OF_BASE_ADDR+0x14
#define NETFPGA_OF_ARP_PARSE_CNT_2_REG		OF_BASE_ADDR+0x15
#define NETFPGA_OF_ARP_PARSE_CNT_3_REG		OF_BASE_ADDR+0x16
#define NETFPGA_OF_ARP_PARSE_CNT_4_REG		OF_BASE_ADDR+0x17
#define NETFPGA_OF_IP_TP_PARSE_CNT_0_REG	OF_BASE_ADDR+0x18
#define NETFPGA_OF_IP_TP_PARSE_CNT_1_REG	OF_BASE_ADDR+0x19
#define NETFPGA_OF_IP_TP_PARSE_CNT_2_REG	OF_BASE_ADDR+0x1a
#define NETFPGA_OF_IP_TP_PARSE_CNT_3_REG	OF_BASE_ADDR+0x1b
#define NETFPGA_OF_IP_TP_PARSE_CNT_4_REG	OF_BASE_ADDR+0x1c
#define NETFPGA_OF_LAST_OUTSIDE_REG		OF_BASE_ADDR+0x1c
#define NETFPGA_OF_ACC_RDY_REG			OF_BASE_ADDR+0x1d
#define NETFPGA_OF_BASE_ADDR_REG	 	OF_BASE_ADDR+0x1e
#define NETFPGA_OF_WRITE_ORDER_REG		OF_BASE_ADDR+0x1f
#define NETFPGA_OF_MOD_WRITE_ORDER_REG		OF_BASE_ADDR+0x20
#define NETFPGA_OF_READ_ORDER_REG		OF_BASE_ADDR+0x21
#define NETFPGA_OF_ENTRY_BASE_REG		OF_BASE_ADDR+0x22
#define NETFPGA_OF_LOOKUP_CMP_BASE_REG		OF_BASE_ADDR+0x22
#define NETFPGA_OF_LOOKUP_CMP_MASK_BASE_REG	OF_BASE_ADDR+0x2a
#define NETFPGA_OF_LOOKUP_ACTION_BASE_REG	OF_BASE_ADDR+0x32
#define NETFPGA_OF_STATS_BASE_REG		OF_BASE_ADDR+0x3c
