 ...
 */
hal_result_t cmm_notify_port_status_changed(switch_port_snapshot_t* port)
{
 ...
 * @ingroup cmm_management
 */
hal_result_t cmm_notify_port_delete(switch_port_snapshot_t* port)
{
 ...
 * @ingroup cmm_management
 */
hal_result_t cmm_notify_port_add(switch_port_snapshot_t* port)
{
	fprintf(stderr,"<%s:%d> HCL has been called (port_no=%d)\n",__func__,__LINE__,port->of_port_num);
	return HAL_SUCCESS;
}
