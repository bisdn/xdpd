...
public:
	...
	static rofl_result_t __notify_port_attachment(const switch_port_snapshot_t* port_snapshot);	
	static rofl_result_t __notify_port_status_changed(const switch_port_snapshot_t* port_snapshot);	
	static rofl_result_t __notify_port_detachment(const switch_port_snapshot_t* port_snapshot);	
