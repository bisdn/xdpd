...
protected:
	...
	void parse_matching_algorithms(libconfig::Setting& setting, of_version_t version, unsigned int num_of_tables, int* ma_list);
	void parse_ports(libconfig::Setting& setting, std::vector<std::string>& ports);
private:
