...
//I/O subsystem
	...
	#error Polling I/O strategy is NOT supported.
#endif

COMPILER_ASSERT(INVALID_io_sched_strategy , ((IO_KERN_SCHED_POL == SCHED_OTHER) || (IO_KERN_SCHED_POL == SCHED_FIFO ) || (IO_KERN_SCHED_POL == SCHED_RR) ) );
